...
class TaskChampionWidget(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.task_layout = QtWidgets.QVBoxLayout()   # Create a vertical layout.    
        ...
        self.task_layout.addWidget(self.addButton)  # Add the push button to the layout.
        
        self.task_layout.addWidget(self.mainTab)  # Add the tab widget to the layout.
