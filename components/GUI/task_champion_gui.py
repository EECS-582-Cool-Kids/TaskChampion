...
from .task_champion_widget import TaskChampionWidget, TaskChampionWidgetImpl, TaskChampionWidgetTest

class TaskChampionGUI:
    """The main application class for Task Champion."""  
    def __init__(self, load_styles : Callable[[], None], widgetType : type[TaskChampionWidget]): 
        ...
        self.main_widget = widgetType(load_styles)  # Create a new TaskChampionWidget.
...
class TaskChampionGUIImpl(TaskChampionGUI):
    def __init__(self):
        super().__init__(self.load_styles, TaskChampionWidgetImpl)
...
class TaskChampionGUITest(TaskChampionGUI):
    def __init__(self):
        super().__init__(lambda: None, TaskChampionWidgetTest)
    
    def on_exit(self) -> int:
        raise RuntimeError("Test GUI object cannot be opened")